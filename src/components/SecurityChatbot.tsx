...
const SecurityChatbot = () => {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "🛡️ **GuardianAI Security Assistant**\n\nI'm here to help you understand and defend against AI-generated threats — deepfakes, voice clones, and social engineering attacks.\n\nAsk me anything about cybersecurity!" },
  ]);
